...
# df consist of three functions:
#get() which returns the matrix to invert,
#getsolve() which stores in "m" the inverted matrix. Notice that "m" is stored in makecacheMatrix() function.
...
#and finally it stores it in m variable (remember, that m is stored in makeCacheMatrix()).
